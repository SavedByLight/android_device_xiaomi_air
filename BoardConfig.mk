...
# Display
TARGET_SCREEN_DENSITY := 260 # PPI is 260
...
BOARD_SYSTEMIMAGE_PARTITION_TYPE := ext4 # (PARTIONS ARE EROFS)
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
TARGET_COPY_OUT_VENDOR := vendor
BOARD_SUPER_PARTITION_SIZE := 7516192768 # VERIFIED
...
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := 7505707008 # VERIFIED
...
TW_BRIGHTNESS_PATH := /sys/class/leds/lcd-backlight/brightness # init.recovery.rc not updated
